...
import {
  appendFreshSnapshot,
  formatAutomationToolOutput,
  inferActiveDomain,
  normalizeOptional,
  normalizeOptionalJsonRecord,
  normalizeOptionalStringRecord,
  normalizeStringList,
  normalizeViewportRect,
  primeBrowserContextFromSnapshot,
  resolveAliasTabId,
  runAutomationTool,
} from './builtin-tool-helpers';
import { createLegacyAliasTools } from './legacy-alias-tools';
import {
  browserClick,
  browserDownloadWait,
  browserDrag,
