...
import { signatureFromElement } from '../../shared/browser-snapshot-signature';

export {
  isConfidentActionMemoryScore,
  scoreElementSignature,
  signatureFromElement,
} from '../../shared/browser-snapshot-signature';
