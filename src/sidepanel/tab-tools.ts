...
/** tabs.listInteractiveElements — list visible interactive elements on a tab */
...
/** tabs.click — click a visible element on a tab by CSS selector */
...
/** tabs.type — replace the value/text of an input-like element on a tab */
...
/** tabs.fillForm — fill multiple form fields on a tab and optionally submit */
